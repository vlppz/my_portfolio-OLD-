...
function Home() {
    return (
        <main className='pxl-10 pt-5 pb-10'>
            ...
            <p className="text-xl w-screen text-center mt-3 font-light">I live in Moscow, and I like to be a frontend developer.<br />I've done some projects and you can see them in this portfolio.</p>
            <h1 className="text-2xl w-screen text-center mt-10">My favourite tools:</h1>
